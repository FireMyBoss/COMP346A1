...
public class Network {
     ...
     */
     public boolean receive(Transactions outPacket) {
         ...
         if ( getoutputIndexClient( ) == getinputIndexServer( )) { /* Check if output buffer is empty */
     ...
     */
     public boolean transferOut(Transactions outPacket) {
    	 ...
    	 if ( getinputIndexServer( ) == getoutputIndexClient( )) { /* Check if output buffer is full */
     ...
     */
     public boolean transferIn(Transactions inPacket) {
		...
		if ( getoutputIndexServer( ) == getinputIndexClient( )) { /* Check if input buffer is empty */
    ...
    public void run() {	
    	...
    	System.out.println("\n DEBUG : Network.run() -  ing network thread");
